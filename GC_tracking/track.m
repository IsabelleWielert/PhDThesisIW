function tracks = track(xyzs, maxdisp, h_output, param)
...
%                end
    ...
    if (ispan == zspan) | (i == z)
        ...
        if quiet~=1
            set(h_output, 'String', ['Track: ',num2str(i), ' of ' ,num2str(z), ' done.']);
            drawnow
        end
