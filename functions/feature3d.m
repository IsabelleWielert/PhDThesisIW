function [r]=feature3d(image,masksz, xyzmax, sep, masscut, threshold)
...
id=find(x>masksz(1) & x<xyzmax(1)+extent(1)-masksz(1) & y>masksz(2) & y<xyzmax(2)+extent(2)-masksz(2) & z>masksz(3) & z<xyzmax(3)+extent(3)-masksz(3));
...
rsq   = lrsqd3dMB(extent,masksz(3)/masksz(1));
